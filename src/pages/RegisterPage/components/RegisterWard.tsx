import { BackIcon, EnterIcon, PenIcon, PlusIcon, XIcon } from '@assets/svg';
...
function RegisterWard() {
  ...
  return (
    <form onSubmit={handleSubmit((d) => console.log(d))} className="flex w-full flex-col">
      ...
      <BackIcon className="absolute left-[-2.5rem] top-0 h-[3rem] w-[3rem] translate-x-[-100%] cursor-pointer" />
