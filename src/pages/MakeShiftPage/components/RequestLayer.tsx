...
function RequestLayer({ isAccept, request }: Props) {
  return (
    <div
      className={`absolute left-[1px] z-10 flex h-[2.125rem] w-[2.125rem] justify-center rounded-[.5625rem] border-[.125rem]
        ${isAccept ? 'border-[#06E738] bg-[#06e73833]' : 'border-[#0027F4] bg-[#0027f433]'}
      `}
    >
      {!isAccept && (
        <div className="invisible relative top-[-21px] z-30 flex justify-center group-hover:visible">
