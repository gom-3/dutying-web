...
function CreateShiftModal({ open, shiftType, close, onSubmit, onDelete }: Props) {
  ...
  return open
    ? createPortal(
        <div
          className="fixed top-0 left-0 z-1002 h-screen w-screen bg-[#00000066]"
          onClick={() => close()}
        >
          <div
          ...
          >
            <div className="flex items-center">
              <h1 className="font-apple flex-1 text-[1.75rem] font-semibold text-[#150B3C]">
            ...
            <div className="mt-7.5 flex">
              <div
                className={`font-apple h-10 flex-1 cursor-pointer border-b-[.3125rem] text-center text-[1.25rem] font-medium ${
            ...
            <div className="w-[50%]">
              <p className="font-apple text-sub-3 mt-8.75 mb-[.625rem] text-base">근무명</p>
              <TextField
                className="font-apple text-sub-1 h-13.5 text-[1.5rem] font-medium"
            ...
            <div className="">
              <div className="flex items-center gap-4">
                <p className="font-apple text-sub-3 mt-7.5 mb-[.625rem] text-base">약자</p>
                <p className="font-apple text-main-2 mt-7.5 mb-[.625rem] text-[.75rem]">
                  * 기본 근무 유형인 D, E, N, O의 약자는 수정하실 수 없습니다
                </p>
              </div>
              <TextField
                className="font-apple text-sub-1 h-13.5 w-13.5 px-0 text-center text-[1.5rem] font-medium"
            ...
            {!writeShift.isOff && (
              <div className="w-[40%]">
                <p className="font-apple text-sub-3 mt-7.5 mb-[.625rem] text-base">근무 시간</p>
                <div className="flex items-center gap-[.9375rem]">
                  ...
                  />
                  <p className="font-poppins text-sub-3 text-[1.5rem]">~</p>
                  <TimeInput
                    className="h-13.5 w-35 text-center text-[1.5rem]"
            ...
            <div className="flex flex-col items-start">
              <p className="font-apple text-sub-3 mt-7.5 mb-[.625rem] text-base">배경 색</p>
              <div className="flex flex-1 items-center gap-17.5">
                <label
                  htmlFor={`pick_background_color`}
                  className={`border-sub-4.5 h-13.75 w-13.75 rounded-full border-[.0625rem]`}
            ...
            <div className="flex">
              {!shiftType?.isDefault && (
                <Button
                  className="border-sub-2.5 text-sub-2.5 absolute right-31.75 bottom-7.5 h-10 w-18.75 text-[1.25rem] font-semibold"
                  type="outline"
                  onClick={() => {
                    onDelete();
                    close();
