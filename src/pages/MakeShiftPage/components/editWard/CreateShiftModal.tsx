        ...
        <div className="fixed left-0 top-0 z-[1002] h-screen w-screen bg-[#00000066]" onClick={() => close()}>
          ...
          >
            <div className="flex items-center">
              <h1 className="flex-1 font-apple text-[1.75rem] font-semibold text-text-1">{shiftType ? '근무•휴가 수정하기' : '근무•휴가 추가하기'}</h1>
              <CancelIcon className="size-[1.875rem] cursor-pointer" onClick={() => close()} />
            </div>
            ...
            <div className="">
              <div className="flex items-center gap-4">
                ...
                <p className="mb-[.625rem] mt-[1.875rem] font-apple text-[.75rem] text-main-2 ">* 기본 근무 유형인 D, E, N, O의 약자는 수정하실 수 없습니다</p>
              </div>
              <TextField
                className="size-[3.375rem] px-0 text-center font-apple text-[1.5rem] font-medium text-sub-1"
            ...
            <div className="flex flex-col items-start">
              ...
              <div className="flex flex-1 items-center gap-[4.375rem]">
                <label
                  ...
                  className={`size-[3.4375rem] rounded-full border-[.0625rem] border-sub-4.5`}
                  style={{ backgroundColor: writeShift.color }}
                />
                <input
                  id={`pick_background_color`}
                  className="absolute size-[3.4375rem] opacity-0"
                  type="color"
            ...
            <div className="flex">
              {!shiftType?.isDefault && (
                <Button
                  className="absolute bottom-[1.875rem] right-[7.9375rem] h-10 w-[4.6875rem] border-sub-2.5 text-[1.25rem] font-semibold text-sub-2.5"
                  type="outline"
                  onClick={() => {
                    onDelete();
                    close();
              ...
              <Button
                className="absolute bottom-[1.875rem] right-[2.625rem] h-10 w-[4.6875rem] text-[1.25rem] font-semibold"
                type="outline"
