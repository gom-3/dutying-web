        ...
        <div className="relative flex flex-[1] items-center justify-center border-r-[.0625rem] border-sub-4 px-[4.6875rem]">
          ...
          <div className="flex items-center gap-[1.25rem]">
            ...
            <Select
              ...
              onChange={(e) => changeWard('maxContinuousWork', parseInt(e.target.value))}
              options={[
                { value: 4, label: '4일' },
                { value: 5, label: '5일' },
                { value: 6, label: '6일' },
        ...
        <div className="relative flex flex-[1] items-center justify-center border-r-[.0625rem] border-sub-4 px-[4.6875rem]">
          ...
          <div className="flex items-center gap-[1.25rem]">
            ...
            <Select
              ...
              onChange={(e) => changeWard('maxContinuousNight', parseInt(e.target.value))}
              options={[
                { value: 3, label: '3일' },
                { value: 4, label: '4일' },
                { value: 5, label: '5일' },
        ...
        <div className="relative flex flex-[1] items-center justify-center px-[4.6875rem]">
          ...
          <div className="flex items-center gap-[1.25rem]">
            ...
            <Select
              ...
              onChange={(e) => changeWard('minNightInterval', parseInt(e.target.value))}
              options={[
                { value: 3, label: '3일' },
                { value: 4, label: '4일' },
                { value: 5, label: '5일' },
