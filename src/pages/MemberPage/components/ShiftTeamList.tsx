  ...
  return (
    <div>
      <div className="mt-7.5 flex items-end gap-[.625rem]">
        <h1 className="font-apple text-text-1 text-[1.75rem] font-semibold">팀</h1>
        <p className="font-apple text-sub-2.5 text-base">팀당 근무표 1개 생성 가능합니다.</p>
        <button
          className="border-main-3 font-apple text-main-2 ml-4.5 flex h-9 items-center gap-[.5rem] rounded-[.3125rem] border-[.0625rem] bg-white px-[.75rem] text-base"
          onClick={() => {
            createShiftTeam();
            sendEvent(events.memberPage.createShiftTeam);
          }}
        >
          <PlusIcon className="stroke-main-2 h-6 w-6" />팀 추가하기
        </button>
      </div>
        ...
        <div className="mb-8 flex items-start gap-10">
          {shiftTeams?.map((shiftTeam) => (
            <div
              id="shift_team_list"
              ref={clickAwayRef}
              className="border-sub-4.5 shadow-banner mt-5.5 flex w-75 flex-col rounded-[.9375rem] border-[.0625rem]"
            ...
            >
              <div className="bg-sub-2 relative flex w-full items-center justify-between rounded-t-[.9375rem] px-5 py-[.875rem]">
                <div className="flex flex-col gap-[.3125rem]">
                  {editShiftTeam?.shiftTeamId === shiftTeam.shiftTeamId ? (
                    <TextField
                      ...
                      className="font-apple text-sub-4 outline-main-2 focus:outline-main-2 ml-[-.5rem] bg-transparent px-[.5rem] text-[1.5rem] font-semibold"
                      autoFocus
                    />
                  ) : (
                    <h2
                ...
                {openMenu === shiftTeam.shiftTeamId && (
                  ...
                  >
                    <div
                      className="border-main-3 font-apple text-sub-2 relative flex flex-1 cursor-pointer items-center gap-[.3125rem] border-b-[.0625rem] px-6.25 text-[1.25rem] font-medium last:border-none"
                      onClick={() => {
                    ...
                    >
                      ...
                      <div className="font-apple text-sub-2 shadow-shadow-2 invisible absolute top-[50%] -right-86 z-30 flex w-91 translate-y-[-50%] items-center gap-[.5rem] rounded-[.3125rem] bg-white px-2 py-1 text-[.875rem] peer-hover:visible">
                        <div
                    ...
                    <div
                      className="border-main-3 font-apple text-sub-2 flex flex-1 cursor-pointer items-center border-b-[.0625rem] px-6.25 text-[1.25rem] font-medium last:border-none"
                      onClick={() => {
                              ...
                              >
                                ...
                                {index !== divisionNurses.length - 1 ? (
                                  ...
                                  >
                                    ...
                                    <p className="font-apple text-sub-2.5 invisible absolute bottom-0 left-0 translate-x-[calc(.625rem-100%)] translate-y-[-50%] text-[.75rem] peer-hover:visible">
                                      구분선
                                    </p>
                                  </div>
                                ) : (
                                  divisionIndex !==
                                    ...
                                    >
                                      <div className="peer absolute bottom-0 z-30 h-[.8rem] w-full translate-y-[50%]" />
                                      <div className="bg-red invisible absolute bottom-0 h-[.0938rem] w-full translate-y-full peer-hover:visible" />
