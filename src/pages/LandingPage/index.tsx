...
function LandingPage() {
  return (
    <div className="flex w-screen flex-col">
      {/* 헤더 */}
      <div className="fixed top-0 h-[60px] w-full bg-white xl:h-[4.5rem]">
      ...
      <div className='h-screen w-screen bg-[url("/img/landing_mobile_1.png")] bg-cover bg-center pt-[60px] xl:mt-[4.5rem] xl:h-[67.5rem] xl:bg-[url("/img/landing_1.png")] xl:pt-0'>
        <div className="mx-auto flex h-full w-[85%] flex-col pt-[42px] xl:container xl:mt-0">
          ...
          <div className="mt-[15px] flex h-[38px] gap-[10px]">
            <div className="flex flex-1 items-center justify-center rounded-[8px] bg-white font-apple text-[16px] font-semibold xl:w-[15.3125rem] xl:flex-none xl:shadow-shadow-2">
              데모 테스트 해보기
            </div>
            <div className="flex flex-1 items-center justify-center gap-[9px] rounded-[8px] bg-white font-apple text-[16px] font-semibold xl:w-[15.3125rem] xl:flex-none xl:shadow-shadow-2">
      ...
      <div className='h-screen w-screen bg-[url("/img/landing_mobile_2.png")] bg-cover bg-center xl:h-[67.5rem] xl:bg-[url("/img/landing_2.png")]'>
        <div className="mx-auto flex h-full w-[85%] flex-col pt-[124px] xl:mx-0 xl:mt-[8.875rem] xl:w-[28%]">
      ...
      <div className='h-screen w-screen bg-[url("/img/landing_mobile_3.png")] bg-cover bg-center xl:h-[67.5rem] xl:bg-[url("/img/landing_3.png")]'>
        <div className="mx-auto flex h-full w-[85%] flex-col pt-[64px] xl:mx-0 xl:mt-[8.875rem] xl:w-[28%]">
          <div className="flex items-center gap-[8px]">
      ...
      <div className='h-screen w-screen bg-[url("/img/landing_mobile_4.png")] bg-cover bg-center xl:h-[67.5rem] xl:bg-[url("/img/landing_4.png")]'>
        <div className="mx-auto flex h-full w-[85%] flex-col pt-[124px] xl:mx-0 xl:mt-[8.875rem] xl:w-[28%]">
          <div className="flex items-center gap-[8px]">
      ...
      <div className='h-screen w-screen bg-[url("/img/landing_mobile_5.png")] bg-cover bg-center xl:h-[67.5rem] xl:bg-[url("/img/landing_5.png")]'>
        <div className="mx-auto flex h-full w-[85%] flex-col pt-[124px] xl:mx-0 xl:mt-[8.875rem] xl:w-[28%]">
          <div className="flex items-center gap-[8px]">
            <div className="flex h-[22px] items-center rounded-[5px] bg-main-4 px-[6px] font-poppins text-[14px] text-main-1">
              App
      ...
      <div className="h-[770px] w-screen">
        <div className="mx-auto flex w-[85%] flex-col pt-[62px] xl:mx-0 xl:mt-[8.875rem] xl:w-[28%]">
          ...
          <div className="mt-[12px] flex h-[38px] gap-[10px]">
            <div className="flex flex-1 items-center justify-center rounded-[8px] bg-sub-5 font-apple text-[16px] font-semibold">
              데모 테스트 해보기
            </div>
            <div className="flex flex-1 items-center justify-center gap-[9px] rounded-[8px] bg-sub-5 font-apple text-[16px] font-semibold">
          ...
          <p className="mt-[62px] font-apple text-[16px] font-semibold text-sub-2">
            자주 묻는 질문
          </p>
          <p className="mb-[72px] mt-[24px] font-apple text-[16px] font-semibold text-sub-2">
            제휴 문의
          </p>
        </div>
        <div className="h-[1px] w-full bg-sub-4.5" />
        <div className="mx-auto flex w-[85%] gap-[24px] pt-[24px]">
          <p className="font-apple text-[14px] font-semibold text-sub-2.5">이용 약관</p>
          <p className="font-apple text-[14px] font-semibold text-sub-2.5">개인 정보 처리 방침</p>
        </div>
      </div>
    </div>
  );
