...
function WebLanding({ open, onClose }: WebLandingProps) {
  const {
  ...
  return (
    <div className="flex w-screen flex-col">
      ...
      <div className='relative h-real-screen min-h-[660px] w-screen bg-[url("/img/landing_1.webp")] bg-cover bg-center bg-no-repeat py-0'>
        <div className="container relative top-1/2 mx-auto h-fit -translate-y-1/2">
          <h1 className="font-line text-[4rem] font-bold leading-[5.4375rem] text-white">
            근무표,
            <br />
            이제 더 간편하게!
          </h1>
          ...
          <div className="mt-[5.1875rem] flex items-center gap-[8px]">
            ...
            <p className="font-apple text-[14px] font-medium text-sub-2">
              근무 일정 관리 (일반 간호사 용)
            </p>
          </div>
          ...
          <div className="mb-20 mt-[.75rem] flex h-[3.75rem] shrink-0 gap-[3.125rem]">
      ...
      >
        <div className="container mx-auto mt-[8.875rem] flex items-start">
          <div className="w-[28.125rem]">
            ...
            <h1 className="mt-[.75rem] font-line text-[3.25rem] font-bold leading-[142%] text-white">
              근무관리부터
              <br />
              개인 일정까지 한번에
            </h1>

            <p className="mt-[2.625rem] font-apple text-[1.75rem] font-medium leading-normal text-[#FDFCFEB2]">
              매월 근무 등록하고
              <br />
              개인 일정을 유형별로 관리해보세요.
            </p>
      ...
      <div className='h-real-screen w-screen bg-[url("/img/landing_5.webp")] bg-cover bg-center bg-no-repeat'>
        <div className="container mx-auto mt-[8.875rem] flex justify-end">
          <div className="w-[28.125rem]">
            ...
            <h1 className="mt-[.75rem] font-line text-[3.25rem] font-bold leading-[142%] text-text-1">
              동료의 근무 일정을
              <br />
              한눈에
            </h1>

            <p className="mt-[2.625rem] font-apple text-[1.75rem] font-medium leading-normal text-sub-2">
              동료와 친구를 맺어
              <br />
              일정을 편하게 조율해보세요.
            </p>
      ...
      <div className="h-[31.25rem] w-screen">
        <div className="container mx-auto mt-[6.875rem] flex flex-row-reverse items-stretch px-[11.25rem]">
          <div className="flex-1">
            <h1 className="mt-0 font-apple text-[1.25rem] font-semibold text-sub-2">
              듀팅 다운로드
            </h1>
