...
const DutySetupPage = () => {
  ...
  return (
    <div className="relative w-[100vw] p-[3.4375rem]">
      ...
      <Setting name="최대 연속 근무" value="5일" modal={1} edit={handleClickPenIcon} />
      <Setting name="최대 연속 나이트" value="3일" modal={2} edit={handleClickPenIcon} />
      <Setting name="최소 나이트 간격" value="10일" modal={2} edit={handleClickPenIcon} />
