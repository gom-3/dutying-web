...
const SvgDutyIconSelected = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 46 45" {...props}>
    <g stroke="#844AFF" strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} clipPath="url(#duty_icon_selected_svg__a)">
    ...
    <defs>
      <clipPath id="duty_icon_selected_svg__a">
        <path fill="#fff" d="M.5 0h45v45H.5z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgDutyIconSelected;
