...
const SvgViteIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    aria-hidden="true"
    className="vite_icon_svg__iconify vite_icon_svg__iconify--logos"
    viewBox="0 0 256 257"
    {...props}
  >
    <defs>
      <linearGradient id="vite_icon_svg__a" x1="-.828%" x2="57.636%" y1="7.652%" y2="78.411%">
        <stop offset="0%" stopColor="#41D1FF" />
        <stop offset="100%" stopColor="#BD34FE" />
      </linearGradient>
      <linearGradient id="vite_icon_svg__b" x1="43.376%" x2="50.316%" y1="2.242%" y2="89.03%">
